...
current_emissions['country'] = current_emissions['Country']
...
children=[
    html.Div(children=[
        html.H1(children='Enabling responsible production lines and green consumption links', style={'textAlign': 'center','color': colors['background'],"margin-left": "2rem",
        "margin-right": "2rem"
        }),
...
For illustration purposes, we use the food processing sector and bring out a view to help policymakers across countries design tax reforms to support sustainable developmental efforts. These choices that will shape our energy use, our environment and our wellbeing through directed focus in each sector
       ...
       ,html.Div(className = 'row',children=[
        html.H1("Select a emission",style={'textAlign': 'center','fontSize': 20}),
...
''',style={
        'color': colors['text1'],"margin-left": "1rem",
        'fontSize': 18}),
        html.Div(children='''
...
''',style={
        ...
        html.Br(),
        dcc.Link('Details on emissions from Food Processing', href='/page-1',style={'textAlign':'centre',"margin-left": "2rem",}),
...
def update_line(country,emission):
    fig3 = px.line(line_chart[(line_chart.Year.isin(['2018','2025','2030','2040']))&
              ...
              y="Emissions", 
              color='Scenario',
              title = "Scenario policy wise Emissions")
...
page_1_layout = html.Div(
  ...
  'backgroundColor': colors['background']},children=[
    html.Div(children=[
        html.H1(children='Food processing sector', style={'textAlign': 'center','color': colors['background'],"margin-left": "2rem",
        "margin-right": "2rem",
        "padding": "2rem 1rem"}),
        ### Sunburst chart 
    ...
    html.Br(),
    dcc.Link('Back to Energy Emissions view', href='/'),
